...
class VizualLib:
    ...
    def heat_map(self, figsize:tuple=(16, 12), fmt:str='.2f', annot_kws:dict={"size": 8}, linewidths:float=1.9, cmap:str='BuGn', 
        ...
        seaborn.heatmap(self.__data.corr(), linewidths=linewidths, square=square, cmap="BuGn",
                    linecolor=linecolor, annot=True, annot_kws=annot_kws,mask=mask,cbar_kws={"shrink": .5}, ax=ax, fmt=fmt, **kwargs)
